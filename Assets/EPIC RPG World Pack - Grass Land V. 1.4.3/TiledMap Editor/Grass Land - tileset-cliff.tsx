...
<tileset version="1.5" tiledversion="1.7.2" name="grass land - tileset-cliff" tilewidth="32" tileheight="32" tilecount="70" columns="10">
 <image source="../Tilesets/tileset-cliff.png" width="320" height="224"/>
 <wangsets>
